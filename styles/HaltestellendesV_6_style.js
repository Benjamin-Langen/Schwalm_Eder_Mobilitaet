...
var style_HaltestellendesV_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("OPNV-Kennzahl_Werktags");
        if ("" !== null) {
            labelText = String("");
        }
    ...
    if (value >= 0.000000 && value <= 2.000000) {
        ...
        image: new ol.style.Icon({
                  ...
                  anchorYUnits: "pixels",
                  rotation: 0.0,
                  src: "styles/transport_bus_stop_3.svg"
            }),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
        ...
        image: new ol.style.Icon({
                  ...
                  anchorYUnits: "pixels",
                  rotation: 0.0,
                  src: "styles/transport_bus_stop_4.svg"
            }),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
