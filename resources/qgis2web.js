...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [866666.807106, 6467989.602043, 1193180.312931, 6766604.952963], maxZoom: 17, minZoom: 10
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([866666.807106, 6467989.602043, 1193180.312931, 6766604.952963], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mobilität im Schlwam-Eder Kreis</h2>';
        return titleElement;
    })(),
